  ...
  return (
    <Card className="group overflow-hidden border-0 shadow-lg bg-background/5 backdrop-blur-sm h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      <div className="relative w-full aspect-[16/12] overflow-hidden">
        {/* Background gradient */}
        <div className={`absolute inset-0 bg-gradient-to-r ${gradientBg} transition-all duration-500 group-hover:opacity-90`}></div>
        ...
        <Image
          ...
          alt={title}
          fill
          className="object-cover mix-blend-overlay opacity-60 transition-transform duration-700 group-hover:scale-105"
        ...
        {/* Badge */}
        <Badge className={`absolute top-4 right-4 ${badgeColor} text-white backdrop-blur-sm text-xs font-semibold px-3 py-1.5 transition-transform duration-300 group-hover:scale-110`}>
      ...
      <CardFooter className="p-4 flex justify-between items-center bg-gradient-to-r from-background to-background/80 transition-all duration-300 group-hover:from-background/90 group-hover:to-background/70">
        {additionalInfo && (
          <div className="flex items-center gap-2 transition-all duration-300 group-hover:translate-x-1">
            ...
            <Badge variant="secondary" className="font-medium transition-transform duration-300 group-hover:scale-105">
